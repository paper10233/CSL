...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--match_thres', type=float, default=0.4, help='confidence thresh for matching')
    ...
    self.parser.add_argument('--data_dir', type=str, default='/media/ubuntu/e1c57dab-f3ee-4ae3-839f-38a0448c56df/ms1/FairMOT-master/dataset')
    ...
    self.parser.add_argument('--reid_loss', type=str, default='cycas_loss',
                             help='the loss function for reid')
    self.parser.add_argument('--reid_area', type=str, default='',
                             help='the area in the image, the boxes locates within this area is account for reid loss, default all boxes')
